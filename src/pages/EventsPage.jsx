    ...
    <>
      ...
      <section className="section-shell pt-0">
        ...
        {filteredEvents.length === 0 ? (
          <ScrollReveal>
            <div className="rounded-[1.75rem] border border-dashed border-black/10 bg-white py-16 text-center dark:bg-white/5">
              <p className="text-base font-medium text-jsd-black/50">
                Sem eventos com estes critérios.
              </p>
              <button
                type="button"
