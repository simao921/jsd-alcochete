          ...
          <div className="mt-4 flex flex-col gap-6">
            <div className="flex gap-4">
              {socialLinks.map((item) => (
                <a key={item.label} href={item.href} target="_blank" rel="noreferrer" aria-label={item.label} className="text-white/80 transition hover:text-white hover:scale-110">
                  {item.icon === "facebook" && (
            ...
            <span className="text-sm text-white/55">© 2026 Juventude Social Democrata. Todos os direitos reservados.</span>
          </div>
        </div>
      </div>
    </footer>
